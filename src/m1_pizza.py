...
def run_test_draw_points_on_circle():
    ...
    title = 'DRAW_POINTS_ON_CIRCLE, test 3:  5 red dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_pizza():
    ...
    title = 'PIZZA test 3:  1000 slices, thin (thickness=3) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    pizza(window, circle, 1000, 'black', 3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    title = 'POLYGON tests 1 and 2:  8 segments with medium red lines.'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.outline_thickness = 3
    polygon(window, circle, 8, 'red', 5)
    window.continue_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON tests 3:  1000 blue lines, hops = 2'
    window = rg.RoseWindow(520, 400, title)

    circle = rg.Circle(rg.Point(100, 100), 80)
    fancy_polygon(window, circle, 1000, 2, 'blue', 3)
    window.continue_on_mouse_click()
